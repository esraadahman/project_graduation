...
class ColorsClass {
  ...
  static const LinearGradient appGradient2 = LinearGradient(
    ...
    colors: [
      Color(0xFFF5FAFF),
      Color(0xFFEAF4FF), // a slightly darker shade
    ],
  );

  static const LinearGradient softGreyGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [
      Color(0xFFE1DEDE),
      Color(0xFFF0EEEE), // slightly lighter version for soft transition
    ],
  );
...
// );
  ...
  static const LinearGradient ContainerSpacer = LinearGradient(
    begin: Alignment.centerLeft,
    end: Alignment.bottomRight,
    colors: [
      Color(0xFFFFC107),
