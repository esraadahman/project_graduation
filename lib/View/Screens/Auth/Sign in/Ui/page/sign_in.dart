...
import 'package:gradution_project/View/Screens/Auth/Sign%20in/cubit/cubit/sign_in_cubit.dart';
      ...
      child: BlocConsumer<SignInCubit, SignInState>(
        listener: (context, state) {
          ...
          if (state is SignInfailer) {
            ...
            context.navigateTo(const NaviBar());
          } else if (state is SignUPWithGoogleFailed) {
            showTopSnackBar(
              Overlay.of(context),
              CustomSnackBar.error(
                message: state.errorMessage,
