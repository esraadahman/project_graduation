        ...
        child: Row(
          ...
          children: [
            Padding(
              ...
              child: allWorkSpaces? SvgPicture.asset(
                height: 24.0,
                width: 24,
                image,              ):CircleAvatar(radius: 18,backgroundColor: const Color.fromARGB(255, 197, 197, 198),),
            ),
            size.width(10),
            allWorkSpaces
    ? ShaderMask(
        ...
        child: Text(
          ...
          style: styling.maintitle.copyWith(
            fontSize: 14.sp,
            color: Colors.white, // White makes shader visible properly
          ),
        ),
      )
    : Text(
